...
fun BookDetailScreen(navController: NavController, bookId: String, viewModel: DetailsViewModel = hiltViewModel()) {
    ...
    Scaffold(topBar = {
        ReadersAppBar(title = "Book Details",
      ...
      Surface(modifier = Modifier
          ...
          horizontalAlignment = Alignment.CenterHorizontally) {
              ...
              //Ask If this is better to use then using the StateFlow/Coroutines scopes combo
...
fun ShowBookDetails(bookInfo: Resource<Item>, navController: NavController) {
    ...
    //used to clear out the html tags
    val cleanDescription =  HtmlCompat.fromHtml(bookData!!.description,
                                                HtmlCompat.FROM_HTML_MODE_LEGACY).toString()
    //this is used to control demotions dynamically
        ...
        dbCollection.add(book)
            ...
            dbCollection.document(docId)
                ...
                .addOnCompleteListener{ task ->
                    ...
                    Log.w("BookDetailsScreen", "saveToFirebase: Error updating doc", it)
                }
